  ...
  return (
    <>
      <div className='flex justify-center items-center gap-10 h-180 px-10 text-white mt-17 max-sm:h-250 max-sm:block max-sm:overflow-hidden'
        ...
        <div className="img">
          <img src={My} alt="" data-aos="fade-up" className='  bg-center w-150 bg-black bg-sticky bg-cover  rounded-4xl h-130 shadow-[10px_20px_20px_rgba(0,0,10,10.100)] max-sm:mt-20 max-sm:h-85 max-sm:rounded-4xl max-sm:w-full' />
        </div>
        ...
        <div className="content w-200 " data-aos="fade-up">
          ...
          <button className="relative group border-2 border-amber-300 text-white rounded-3xl p-4 mt-5 cursor-pointer bg-transparent overflow-hidden transition-colors duration-300 ease-in-out 
           ...
           max-sm:ml-20 max-sm:mt-10 max-sm:transition-all max-sm:duration-300 max-sm:ease-in-out max-sm:hover:bg-amber-300 max-sm:text-white
            max-sm:hover:before:scale-x-0 max-sm:hover:text-black"> 

            <span className="relative z-10 group-hover:text-black transition-colors duration-300 font-bold
            max-sm:group-hover:text-white max-sm:transition-all max-sm:duration-300 max-sm:ease-in-out">
