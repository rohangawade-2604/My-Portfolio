    ...
    <>
      ...
      <div className=' bg-black  text-white flex justify-around items-center '>
        ...
        <div className="Info flex justify-between items-center ">
          ...
          <div className="first-part w-100">
          ...
          <div className="second-part mt-21">
        ...
        <div className="counting-per mt-20">
          <div>
          ...
          <button className="ml-[6%] relative group border-2 border-amber-300 text-white rounded-3xl p-4 mt-5 cursor-pointer bg-transparent overflow-hidden transition-colors duration-300 ease-in-out 
